...
4. Choose an auth method.
   ...
   - **Microsoft Entra ID (OAuth via az login)**: Run `az login` first. The signed-in Azure identity must have the `Cognitive Services OpenAI User` role for the resource.
