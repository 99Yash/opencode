...
1. ไปที่ [พอร์ทัล Azure](https://portal.azure.com/) และสร้างทรัพยากร **Azure OpenAI** คุณจะต้องใช้ **ชื่อทรัพยากร** ซึ่งจะกลายเป็นส่วนหนึ่งของจุดสิ้นสุด API ของคุณ (`https://RESOURCE_NAME.openai.azure.com/`)
...
4. เลือกวิธีการยืนยันตัวตน
   ...
   - **API key**: วาง `KEY 1` หรือ `KEY 2` จากทรัพยากรของคุณ
   - **Microsoft Entra ID (OAuth ผ่าน az login)**: เรียกใช้ `az login` ก่อน ตัวตน Azure ที่ลงชื่อเข้าใช้ต้องมีบทบาท `Cognitive Services OpenAI User` สำหรับทรัพยากรนี้
...
5. หากเลือก API key ให้ป้อน API key ของคุณ
...
6. ไม่บังคับ: ตั้งชื่อทรัพยากรเป็นตัวแปรสภาพแวดล้อมเพื่อข้ามการถามชื่อทรัพยากรระหว่าง `/connect`
...
1. ไปที่ [พอร์ทัล Azure](https://portal.azure.com/) และสร้างทรัพยากร **Azure OpenAI** คุณจะต้องใช้ **ชื่อทรัพยากร** ซึ่งจะกลายเป็นส่วนหนึ่งของจุดสิ้นสุด API ของคุณ (`https://AZURE_COGNITIVE_SERVICES_RESOURCE_NAME.cognitiveservices.azure.com/`)
